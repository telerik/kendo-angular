    ...
    const transactions: Transaction[] = Array.from({ length: 77 }, (_, index) => {
        ...
        return {
            ...
            orderStatus: ['Published', 'Pending', 'Postponed'][Math.floor(Math.random() * 3)] as
                ...
                | 'Postponed'
                | 'N/A',
            category: ['Food and Beverages', 'Shopping', 'Travel', 'Leisure'][Math.floor(Math.random() * 4)] as
                | 'Food and Beverages'
                | 'Shopping'
                | 'Travel'
                | 'Leisure'
            ...
            paymentMethod: ['Debit Card', 'Credit Card', 'Bank Transfer'][Math.floor(Math.random() * 3)] as
                ...
                | 'Bank Transfer'
                | 'N/A',
            cardType: ['Visa', 'Master Card'][Math.floor(Math.random() * 2)] as 'Visa' | 'Master Card' | 'N/A',
