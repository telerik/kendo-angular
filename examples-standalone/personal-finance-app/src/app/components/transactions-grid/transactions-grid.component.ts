...
import { ColumnMenuSettings, KENDO_GRID, PDFModule, RowArgs } from '@progress/kendo-angular-grid';
...
export class TransactionsGridComponent {
    ...
    public selectedKeys: Transaction[] = [];

    public mySelectionKey(context: RowArgs): string {
        return context.dataItem;
    }

    public onSelectedKeysChange(selectedItem: Transaction[]): void {
        this.rowSelection.emit(selectedItem[0] ? selectedItem[0] : new Transaction());
    }
