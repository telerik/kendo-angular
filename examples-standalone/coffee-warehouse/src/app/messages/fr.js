...
export const frCustomMessages = {
    ...
    dashboardSummary: 'Résumé des commandes pour la période sélectionnée',
    ordersInRange: 'Commandes sur la période',
    orderValue: 'Valeur des commandes',
    averageOrderValue: 'Valeur moyenne de la commande',
    activeTeams: 'Équipes actives',
    schedulerStart: 'Début',
    schedulerEnd: 'Fin',
    schedulerTitle: "Titre de l'événement",
    schedulerDescription: 'Description',
    schedulerDescriptionPlaceholder: 'Ajoutez une note sur cette activité de l’entrepôt',
    schedulerAllDayEvent: 'Événement toute la journée',
    schedulerTeam: "Équipe de l'entrepôt",
    teamDescription: "Gérez la disponibilité et les performances de l'équipe de l'entrepôt.",
    dashboardDescription: "Surveillez le volume des commandes et l'efficacité des équipes.",
    planningDescription: "Planifiez les équipes de l'entrepôt et consultez le travail attribué.",
    lastUpdated: 'Dernière mise à jour : à l’instant',
    toggleNavigation: 'Basculer la navigation',
    unreadNotifications: '3 notifications non lues',
    notFoundCode: 'Erreur 404',
    notFoundTitle: 'Page introuvable',
    notFoundDescription: "La page d'entrepôt demandée n'existe pas ou a été déplacée.",
    goToDashboard: 'Aller au tableau de bord principal',
