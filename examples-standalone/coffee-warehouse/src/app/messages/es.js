...
export const esCustomMessages = {
    ...
    dashboardSummary: 'Resumen de pedidos del periodo seleccionado',
    ordersInRange: 'Pedidos del periodo',
    orderValue: 'Valor de pedidos',
    averageOrderValue: 'Valor medio del pedido',
    activeTeams: 'Equipos activos',
    schedulerStart: 'Inicio',
    schedulerEnd: 'Fin',
    schedulerTitle: 'Título del evento',
    schedulerDescription: 'Descripción',
    schedulerDescriptionPlaceholder: 'Añada una nota sobre esta actividad del almacén',
    schedulerAllDayEvent: 'Evento de todo el día',
    schedulerTeam: 'Equipo del almacén',
    teamDescription: 'Gestione la disponibilidad y el rendimiento del equipo del almacén.',
    dashboardDescription: 'Supervise el volumen de pedidos y la eficiencia del equipo.',
    planningDescription: 'Programe los equipos del almacén y revise el trabajo asignado.',
    lastUpdated: 'Última actualización: ahora mismo',
    toggleNavigation: 'Alternar navegación',
    unreadNotifications: '3 notificaciones sin leer',
    notFoundCode: 'Error 404',
    notFoundTitle: 'Página no encontrada',
    notFoundDescription: 'La página solicitada del almacén no existe o se ha movido.',
    goToDashboard: 'Ir al tablero principal',
