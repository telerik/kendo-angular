...
export const enCustomMessages = {
    ...
    dashboardSummary: 'Order summary for the selected period',
    ...
    schedulerEnd: 'End',
    schedulerTitle: 'Event title',
    schedulerDescription: 'Description',
    schedulerDescriptionPlaceholder: 'Add a note about this warehouse activity',
    schedulerAllDayEvent: 'All-day event',
    schedulerTeam: 'Warehouse team',
    teamDescription: 'Manage warehouse team availability and performance.',
    dashboardDescription: 'Monitor order volume and team efficiency.',
    planningDescription: 'Schedule warehouse teams and review assigned work.',
    lastUpdated: 'Last updated: just now',
    toggleNavigation: 'Toggle navigation',
    unreadNotifications: '3 unread notifications',
    notFoundCode: 'Error 404',
    notFoundTitle: 'Page not found',
    notFoundDescription: 'The requested warehouse page does not exist or has been moved.',
