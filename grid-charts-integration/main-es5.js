...
/* harmony import */ var _progress_kendo_angular_charts__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @progress/kendo-angular-charts */ "./node_modules/@progress/kendo-angular-charts/dist/fesm5/index.js");
...
/* harmony import */ var _progress_kendo_angular_popup__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @progress/kendo-angular-popup */ "./node_modules/@progress/kendo-angular-popup/dist/fesm5/index.js");
/* harmony import */ var _progress_kendo_angular_menu__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @progress/kendo-angular-menu */ "./node_modules/@progress/kendo-angular-menu/dist/fesm5/index.js");
/* harmony import */ var _progress_kendo_angular_dropdowns__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @progress/kendo-angular-dropdowns */ "./node_modules/@progress/kendo-angular-dropdowns/dist/fesm5/index.js");
/* harmony import */ var _progress_kendo_angular_inputs__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @progress/kendo-angular-inputs */ "./node_modules/@progress/kendo-angular-inputs/dist/fesm5/index.js");
/* harmony import */ var _progress_kendo_angular_buttons__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @progress/kendo-angular-buttons */ "./node_modules/@progress/kendo-angular-buttons/dist/fesm5/index.js");
/* harmony import */ var _progress_kendo_angular_layout__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @progress/kendo-angular-layout */ "./node_modules/@progress/kendo-angular-layout/dist/fesm5/index.js");
/* harmony import */ var _progress_kendo_angular_tooltip__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @progress/kendo-angular-tooltip */ "./node_modules/@progress/kendo-angular-tooltip/dist/fesm5/index.js");
...
/* harmony import */ var _progress_kendo_file_saver__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @progress/kendo-file-saver */ "./node_modules/@progress/kendo-file-saver/dist/es/main.js");





var StocksChartComponent = /** @class */ (function () {
    function StocksChartComponent() {
    ...
    StocksChartComponent.prototype.onValueChange = function (chartName) {
    ...
    StocksChartComponent.prototype.exportChart = function (chart) {
        chart.exportImage().then(function (data) {
...
var DayChartComponent = /** @class */ (function () {
    function DayChartComponent() {
    }
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
...
var PieDonutStockComponent = /** @class */ (function () {
    function PieDonutStockComponent() {
        this.selectedSeries = 'price';
        this.series = _data__WEBPACK_IMPORTED_MODULE_2__["series"];
        this.seriesTypes = _data__WEBPACK_IMPORTED_MODULE_2__["seriesTypes"].circularSeries;
        this.getTitle = _utils__WEBPACK_IMPORTED_MODULE_3__["getTitle"];
    }
    PieDonutStockComponent.prototype.onValueChange = function (chartName) {
        this.chartConfiguration.seriesType = Object(_utils__WEBPACK_IMPORTED_MODULE_3__["getChartType"])(chartName);
    };
    PieDonutStockComponent.prototype.exportChart = function (chart) {
        chart.exportImage().then(function (data) {
            Object(_progress_kendo_file_saver__WEBPACK_IMPORTED_MODULE_4__["saveAs"])(data, 'chart.png');
        });
    };
...
var ScatterBubbleChartComponent = /** @class */ (function () {
    function ScatterBubbleChartComponent() {
        this.stockData = [];
        this.series = _data__WEBPACK_IMPORTED_MODULE_2__["series"];
        this.selectedSeries = ['price', 'pe'];
    ...
    Object.defineProperty(ScatterBubbleChartComponent.prototype, "data", {
        set: function (value) {
            this.stockData = value.map(function (item, index) {
                item.index = index;
                return item;
            });
        },
    ...
    ScatterBubbleChartComponent.prototype.labelContent = function (args) {
        if (args.value >= 0) {
    ...
    ScatterBubbleChartComponent.prototype.onValueChange = function (chartName) {
        this.chartConfiguration.seriesType = Object(_utils__WEBPACK_IMPORTED_MODULE_3__["getChartType"])(chartName);
    };
    ScatterBubbleChartComponent.prototype.exportChart = function (chart) {
        chart.exportImage().then(function (data) {
            Object(_progress_kendo_file_saver__WEBPACK_IMPORTED_MODULE_4__["saveAs"])(data, 'chart.png');
        });
    };
    ...
    return ScatterBubbleChartComponent;
}());
...
var SelectChartTypeComponent = /** @class */ (function () {
    function SelectChartTypeComponent() {
        this.valueChange = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
    SelectChartTypeComponent.prototype.onChange = function (chartName) {
    ...
    return SelectChartTypeComponent;
}());
...
var SelectSeriesComponent = /** @class */ (function () {
    function SelectSeriesComponent() {
        this.valueChange = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.selectedSeries = ['price', 'pe'];
    }
    SelectSeriesComponent.prototype.onChange = function (value) {
...
var StockListComponent = /** @class */ (function () {
    ...
    StockListComponent.prototype.onCellClick = function (e) {
    ...
    StockListComponent.prototype.selectBy = function (e) {
        return e.dataItem;
    };
    StockListComponent.prototype.onSelectionChange = function () {
        var _this = this;
        if (this.opened) {
            setTimeout(function () {
                _this.mySelection = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](_this.mySelection);
            });
        }
    };
    StockListComponent.prototype.onSelect = function (e) {
    ...
    StockListComponent.prototype.allData = function () {
        var result = {
            data: this.mySelection,
        };
        return result;
    };
    StockListComponent.prototype.close = function () {
        this.opened = false;
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
function getTitle(fieldName) {
    return _data__WEBPACK_IMPORTED_MODULE_0__["series"].find(function (item) { return item.field === fieldName; }).title;
}
