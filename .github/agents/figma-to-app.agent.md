---
name: figma-to-app
description: 'This custom agent transforms detailed design specifications into a production-ready Angular application using Kendo UI components. It follows a systematic workflow to build a healthcare dashboard demo with 5 main screens, realistic mock data, and comprehensive documentation.'
